...
const NavBar = () => {
  ...
  return (
    <>
      {/* mobile navbar */}
      <div className={mobileNavBarOpen === 0 ? "offcanvas__area " : "offcanvas__area offcanvas-opened"}>
    <div className="offcanvas__wrapper">
      <div className="offcanvas__close">
        <button className="offcanvas__close-btn offcanvas-close-btn" onClick={(e)=>{setMobileNavBarOpen(0)}}>
          <svg
            width={12}
            height={12}
            viewBox="0 0 12 12"
                ...
                <div className="main-menu menu-style-2">
                  <nav className="tp-main-menu-content">
                    <ul>
                      ...
                      <li>
                        <Link href="contact.html" className="flex">
                          Contact
                        </Link>
                      </li>
                    </ul>
                ...
                <div className="tp-header-bottom-right d-flex align-items-center justify-content-end pl-30">
                  ...
                  <div className="tp-header-action d-flex align-items-center ml-30">
                    ...
                    <div className="tp-header-action-item tp-header-hamburger mr-20 d-xl-none">
                      <button type="button" className="tp-offcanvas-open-btn" onClick={(e)=>{setMobileNavBarOpen(1)}}>
