...
const PasswordInputBox = ({register}) => {
  ...
  return (
    <>
      <div className="tp-login-input-box">
        ...
        {visible === true ?  ( <div onClick={()=>{setVisible(false) }}> <span id="open-eye"   >
            <svg
              width={18}
              height={14}
              viewBox="0 0 18 14"
          ...
          ( <div onClick={handleShowPassword}> <span id="close-eye" className="open-close">
            <svg
              width={19}
              height={18}
              viewBox="0 0 19 18"
