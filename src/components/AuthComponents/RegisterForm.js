                ...
                <div className="tp-login-wrapper">
                  <div className="tp-login-top text-center mb-30">
                    <h3 className="tp-login-title">
                      Register as New Member on Shofy.
                    </h3>
                    <p>
                ...
                <p>
                  or Sign in with <a href="#">Email</a>
                    ...
                    >
                      ...
                      <div className="tp-login-input-box">
                        <div className="tp-login-input">
                          <input
                            ...
                            id="email"
                            type="email"
                            placeholder="Enter your E-mail id e.g (name@example.com)"
                          />
                        </div>
                        <div className="tp-login-input-title">
                      ...
                      <button
                        className="tp-login-bottom bg-black text-white py-3 font-bold text-center w-full"
                        type="submit"
                      >
                        Register
                      </button>
                    ...
                    {/* <FormButton name={"Register"} NavigateTo={"/login"} /> */}
                  </div>
                </div>
              </div>
            </div>
