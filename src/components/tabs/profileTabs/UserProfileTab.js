...
import { selectUserOrders } from "../../../features/Orders/OrderSlice";
import { Link } from "react-router-dom";

const UserProfileTab = () => {
  const loggedInUser = useSelector(selectLoggedInUserInfo);
  const userOrders = useSelector(selectUserOrders);
  const UserWishlistItem = useSelector(selectUserWishlistItem);
  ...
  return (
    <div className="col-xxl-8 col-lg-8 shadow-effect">
      <div className="profile__main">
        <div className="profile__main-top pb-15">
          <div className="row align-items-center">
            <div className="col-md-6">
              <div className="profile__main-inner d-flex flex-wrap align-items-center">
                <div className="profile__main-thumb">
                  <img src={loggedInUser?.profile} alt="user-image" />
                ...
                <div className="profile__main-content">
                  <h4 className="profile__main-title">Welcome! {loggedInUser?.name}</h4>
                </div>
              </div>
            </div>
            <div className="col-md-6">
        ...
        <div className="profile__main-info">
          <div className="row gx-3">
            <div className="col-md-3 col-sm-6 cursor-pointer">
              <Link to="/order">
