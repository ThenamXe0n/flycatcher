 ...
 id,
  ...
  return (
    <div className="tp-product-list-item d-md-flex">
      <div className="tp-product-list-thumb p-relative fix" id={id}>
        <a href="#">
          <img src={productImg} alt="productImage" style={{width:"282px"}} />
        </a>
        {/* product action */}
      ...
      <div className="tp-product-list-content">
        <div className="tp-product-content-2 pt-15">
          ...
          <div className="tp-product-list-add-to-cart">
            <button className="tp-product-list-add-to-cart-btn">
              Add To Cart
            </button>
          </div>
        </div>
