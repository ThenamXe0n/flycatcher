          ...
          <div className="col-xl-8 col-md-7 col-sm-6">
            <div className="tp-product-offer-more-wrapper d-flex justify-content-sm-end p-relative z-index-1">
              <div className="tp-product-offer-more mb-40 text-sm-end grey-bg-2">
                <a href="shop.html" className="tp-btn tp-btn-2 tp-btn-blue">
                  View All Deals
                  <svg
                    width={17}
                    height={14}
                ...
                <div className="swiper-wrapper">
                  <div className="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                    <div className="tp-product-thumb p-relative fix m-img">
                      <a href="product-details.html">
                        <img
                          src="assets/img/product/offer/product-offer-1.jpg"
                      ...
                      <div className="tp-product-action">
                        <div className="tp-product-action-item d-flex flex-column">
                          <button
                            type="button"
                            className="tp-product-action-btn tp-product-compare-btn"
                          >
                            <svg
                              width={17}
                              height={21}
                            ...
                            >
                              <path
                                d="M12.6666 1L16 4.33333L12.6666 7.66667"
                                stroke="currentColor"
                                strokeWidth="1.5"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                    ...
                    <div className="tp-product-content">
                      ...
                      <div
                        className="tp-product-countdown"
                        data-countdown=""
                  ...
                  <div className="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                    <div className="tp-product-thumb p-relative fix m-img">
                      <a href="product-details.html">
                        <img
                          src="assets/img/product/offer/product-offer-2.jpg"
                          alt="product-electronic"
                        />
                      </a>
                      {/* product action */}
                  ...
                  <div className="tp-product-offer-item tp-product-item transition-3 swiper-slide">
                    <div className="tp-product-thumb p-relative fix m-img">
                      <a href="product-details.html">
                        <img
                          src="assets/img/product/offer/product-offer-3.jpg"
                          alt="product-electronic"
                        />
                      </a>
                      {/* product action */}
