      ...
      <section className="py-24 relative">
        <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
          ...
          {userOrders.map((order) => (
            <div className="main-box border border-gray-200 my-3 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                          ...
                          <div className="col-span-5 lg:col-span-2 flex items-center max-lg:mt-3">
                            <div className="flex gap-3 lg:block">
                              ...
                              <p className="font-medium text-base whitespace-nowrap leading-7 lg:mt-3 text-emerald-500">
                                {moment(order?.placed_on).format("Do MMM YY")}
                              </p>
                            </div>
                          </div>
                        </div>
              ...
              <div className="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
                ...
                <p className="font-semibold text-lg text-black py-6">
                  Total Price: <span className="text-indigo-600"> ₹{order.totalamount}</span>
                </p>
              </div>
            </div>
          ))}
